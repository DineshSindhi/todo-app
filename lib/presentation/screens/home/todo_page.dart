...
import 'package:todo_app/presentation/screens/home/todo_provider.dart';
...
class _TodoPageState extends State<TodoPage> {
  ...
  getId() async {
    ...
    // context.read<TodoProvider>().fecTodo(uId!);
    setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar:AppBar(title: Text('Todos'), centerTitle: true,backgroundColor: Colors.blueGrey,
        actions: [
      ...
      body: uId != null ?
      // Consumer<TodoProvider>(builder: (_, value, __) {
      // var  data= value.todoList;
      //   return ListView.builder(
      //     itemCount: data.length,
      //     itemBuilder: (context, index){
      //       return ListTile(
      //         title: Text('${data[index].title}'),
      //         subtitle: Text('${data[index].taskDesc}'),
      //       );
      //     },);
              ...
              itemBuilder: (context, index) {
                ...
                return Container(
                  ...
                  child: ListTile(
                    ...
                    title: Text('${eachData.title}',style: TextStyle(fontSize: 20,
                      decoration:eachData.isCompleted==true? TextDecoration.lineThrough:TextDecoration.none,),),
                    subtitle: Text('${eachData.taskDesc}',style: TextStyle(decoration:eachData.isCompleted==true? TextDecoration.lineThrough:TextDecoration.none ),),
                    trailing: Column(
                      children: [
                        Text('${dtFor.format(DateTime.fromMillisecondsSinceEpoch(
                            int.parse(eachData.createdAt.toString())))}',style: TextStyle(fontSize: 16,),),
                  ...
                  ElevatedButton(onPressed: () async {
                    if(titController.text.isNotEmpty&&taskDescController.text.isNotEmpty){
                      if (isUpdate) {
                        ...
                        // context.read<TodoProvider>().addTodo(data);
